...
const CustomOrderCTA = () => {
    return (
        <div
            id="custom-order-cta"
            className="w-full px-4 md:px-8 lg:px-12 py-8 bg-gray-50"
        >
                    ...
                    <div className="relative z-10 p-8 md:p-14 flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
                        <div className="flex-1">
                            ...
                            <p className="text-gray-300 text-base md:text-lg leading-relaxed max-w-xl">
                                สั่งทำภาพประกอบ, ชุดแบรนด์ (Brand Kit)
                                หรือเทมเพลตที่ออกแบบเฉพาะสำหรับธุรกิจคุณ
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
                            <Link
                                to="/custom-order"
                                className="btn btn-lg bg-white text-black hover:bg-gray-100 rounded-xl whitespace-nowrap shadow-lg border-none transition-colors flex items-center justify-center"
                            >
                                สั่งทำสินค้าเฉพาะ →
                            </Link>
                            <Link
                                to="/#contact"
                                className="btn btn-lg btn-outline text-white bg-[#2d1b13]/80 hover:bg-[#3d251a] border-[#8a3c1b]/40 hover:border-[#8a3c1b]/60 rounded-xl whitespace-nowrap backdrop-blur-sm transition-colors flex items-center justify-center"
                            >
                                สอบถามเพิ่มเติม
                            </Link>
                        </div>
